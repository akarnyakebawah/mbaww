// ---- nama twibbon (tanpa format) -----
var twibbon = "aspectratio";
  ...
  downloadBtn.addEventListener('click', function() {
       ...
       var ratioY = canvas.height / result.height(),
        ...
        crop_canvas.toBlobHD(function(blob) {
          //  saveAs(blob,"#tumpenganmodeikj2017.png");
          var formData = new FormData();
          formData.append('image', blob); 
          formData.append('twibbon', twibbon);

          var oReq = new XMLHttpRequest();
          oReq.open('POST', '/convert/', true); 
          ...
          oReq.onload = function() {
            ...
            setTimeout(function () { window.location = window.location.host+'result/'+jsonResponse.filename; }, 5000)
          }
          oReq.send(formData);
